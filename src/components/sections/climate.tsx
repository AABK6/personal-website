...
const choices = [
    {
        ...
        image: "https://placehold.co/600x400/cc6633/ffffff",
    ...
    },
    {
        ...
        image: "https://placehold.co/600x400/708090/ffffff",
    ...
    },
    {
        ...
        image: "https://placehold.co/600x400/afeeee/708090",
...
export default function Climate() {
  return (
    <section id="climate" className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-4xl md:text-5xl font-headline text-primary mb-4">Beyond 1.5 Degrees</h2>
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            {choices.map((choice) => (
                <Card key={choice.title} className="overflow-hidden flex flex-col group">
                    ...
                    <CardHeader>
                        <CardTitle className="font-headline text-2xl">{choice.title}</CardTitle>
                    </CardHeader>
