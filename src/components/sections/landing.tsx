        ...
        <div className="relative container mx-auto px-4 z-10">
            ...
            <div className="max-w-3xl mx-auto animate-fade-in-up">
                <p className="text-xl md:text-2xl text-foreground/80 mb-4">
                    Adrien Abecassis — Diplomat, Policy Advisor, Researcher.
                </p>
                <p className="text-lg md:text-xl text-foreground/70">
                    This is a public notebook dedicated to analyzing and experimenting with solutions to complex global challenges. It's a space where policy analysis meets technical exploration, translating high-level strategy into tangible prototypes and actionable insights.
                </p>
            </div>
