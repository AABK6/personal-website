...
export default function Landing() {
  return (
    <section id="home" className="relative h-screen flex items-center justify-center text-center text-foreground bg-cover bg-center" style={{backgroundImage: "url('https://placehold.co/1920x1080/f0f0f0/708090?text=.')"}} data-ai-hint="abstract texture">
        ...
        <div className="relative container mx-auto px-4 z-10">
            ...
            <Link href="#ai" passHref>
                <Button size="lg" variant="outline" className="animate-fade-in-up animation-delay-300">
                    Begin Exploring
