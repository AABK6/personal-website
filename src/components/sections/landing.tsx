...
export default function Landing() {
  return (
    <section id="home" className="relative h-[calc(100vh-5rem)] flex items-center justify-center text-center text-foreground bg-cover bg-center" style={{backgroundImage: "url('https://placehold.co/1920x1080/e0e7ff/4f46e5?text=.')"}} data-ai-hint="abstract colorful">
